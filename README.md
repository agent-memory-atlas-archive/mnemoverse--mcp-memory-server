...
- **Removing or renaming a tool, or dropping a declared annotation field,** is
  announced one MINOR ahead: the tool stays, its description says
  `deprecated since x.y, removed in x.z`, and the change lands only in the
  announced version, with its CHANGELOG line.
